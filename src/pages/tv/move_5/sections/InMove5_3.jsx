...
const InMove5_3 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv2/move-5/zoomBIt/03.png'),
        getBase64('/tv/pictures/tv2/move-5/zoomIn/03.png')
      ]);
      setImage(mainImg);
  ...
  const handleImageMouseMove = (event) => {
    ...
    const inClickableArea = isPointInTvMove5Area(3, mouseX, mouseY, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove5ClickableAreas(3);
  ...
  return (
    <div className="relative w-full h-screen" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        <img 
          src={image || "/tv/pictures/tv2/move-5/regular/03.png"}
          alt="Full Screen Scene"
          className="w-full h-full object-cover"
        />
        {renderClickableAreasDebug()}
        {/* Add clickable area overlay */}
        {getTvMove5ClickableAreas(3).map((area, index) => (
          <div
            key={`clickable-${index}`}
      ...
      {((isAreaHovered || isHoveringZoomImage)) && (() => {
        ...
        return (
          ...
          >
            <img
              src={hoverImage || "/tv/pictures/tv2/move-5/zoomBIt/03.png"}
        ...
        >
          <div className="relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col items-center">
              {/* Image */}
              <img
                src={zoomImage || "/tv/pictures/tv2/move-5/zoomIn/03.png"}
                alt="Zoomed Scene"
                style={{
                  width: '505px',
                  height: '663px',
