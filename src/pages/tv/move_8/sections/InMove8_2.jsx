...
const InMove8_2 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv2/move-8/zoomBit/02.png'),
        getBase64('/tv/pictures/tv2/move-8/zoomIn/02.png')
      ]);
      setImage(mainImg);
  ...
  const imageZoomConfigs = useMemo(() => ({
    2: { zoomSize: 'w-[103px]', zoomHeight: 'h-[162px]', zoomOffset: { x: 200, y: -75 } }
  }), []);
  ...
  const handleImageMouseMove = useMemo(() => (event) => {
    ...
    const inClickableArea = isPointInTvMove8Area(2, mouseX, mouseY, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove8ClickableAreas(2);
    ...
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        ...
        >
          ...
          {getTvMove8ClickableAreas(2).map((area, index) => (
            <div
              key={`clickable-${index}`}
        ...
        {((isAreaHovered || isHoveringZoomImage) && !selectedImage) && (() => {
          ...
          return (
            ...
            >
              <img
                src={hoverImage || "/tv/pictures/tv2/move-8/zoomBit/02.png"}
        ...
        {showZoomInModal && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center">
              {/* Main ZoomIn Image */}
              <img
                src={zoomInImage || "/tv/pictures/tv2/move-8/zoomIn/02.png"}
                alt="Zoomed In Scene"
                style={{ 
                  width: '1590px',
                  height: '663px',
              ...
              >
                ...
                <div style={{
                  ...
                  Wearing a khaki outfit and shoulder bag, Ryan Reynolds' character in the jungle is a clear reference to Indiana Jones.
                </div>
              </div>
            </div>
          </div>
