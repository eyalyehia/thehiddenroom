...
import { isPointInTvMove8Area, getTvMove8ClickableAreas } from '../../../../components/constant/clickableAreas';
...
const InMove8_4 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv2/move-8/zoomBit/04.png'),
        getBase64('/tv/pictures/tv2/move-8/zoomIn/04.png')
      ]);
      setImage(mainImg);
  ...
  const imageZoomConfigs = useMemo(() => ({
    4: { zoomSize: 'w-[362px]', zoomHeight: 'h-[230px]', zoomOffset: { x: 480, y: 120 } }
  }), []);
  ...
  const handleImageMouseMove = useMemo(() => (event) => {
    ...
    const inClickableArea = isPointInTvMove8Area(4, mouseX, mouseY, rect.width, rect.height);
    ...
    else if (!hoveredImage && inClickableArea && !clickedImages.has(4)) {
      handleImageEnter(4);
    }
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove8ClickableAreas(4);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        ...
        >
          <img 
            src={image || "/tv/pictures/tv2/move-8/regular/04.png"}
          ...
          {getTvMove8ClickableAreas(4).map((area, index) => (
            <div
              key={`clickable-${index}`}
        ...
        {((isAreaHovered || isHoveringZoomImage) && !selectedImage) && (() => {
          ...
          return (
            ...
            >
              <img
                src={hoverImage || "/tv/pictures/tv2/move-8/zoomBit/04.png"}
        ...
        {showZoomInModal && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center">
              {/* Main ZoomIn Image */}
              <img
                src={zoomInImage || "/tv/pictures/tv2/move-8/zoomIn/04.png"}
                alt="Zoomed In Scene"
                style={{ 
                  width: '1594px',
                  height: '663px',
              ...
              >
                ...
                <div style={{
                  ...
                  A crate marked "TOP SECRET • ARMY INTEL 9906753 • DO NOT OPEN" mirrors the label from Raiders of the Lost Ark, a reference to Indiana Jones.
                </div>
              </div>
            </div>
          </div>
