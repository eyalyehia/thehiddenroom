...
const InMove8_1 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv2/move-8/zoomBit/01.png'),
        getBase64('/tv/pictures/tv2/move-8/zoomIn/01.png')
      ]);
      setImage(mainImg);
  ...
  const handleImageMouseMove = useMemo(() => (event) => {
    ...
    const inClickableArea = isPointInTvMove8Area(1, mouseX, mouseY, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove8ClickableAreas(1);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        ...
        >
          <img 
            src={image || "/tv/pictures/tv2/move-8/regular/01.png"}
          ...
          {getTvMove8ClickableAreas(1).map((area, index) => (
            <div
              key={`clickable-${index}`}
        ...
        {hoveredImage && !selectedImage && (() => {
          ...
          return (
            ...
            >
              <img
                src={hoverImage || "/tv/pictures/tv2/move-8/zoomBit/01.png"}
                alt="Hover Scene"
        ...
        {showZoomInModal && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center">
              {/* Main ZoomIn Image */}
              <img
                src={zoomInImage || "/tv/pictures/tv2/move-8/zoomIn/01.png"}
                alt="Zoomed In Scene"
                style={{ 
                  width: '1506px',
                  height: '663px',
