...
const InMove8_3 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv2/move-8/zoomBit/03.png'),
        getBase64('/tv/pictures/tv2/move-8/zoomIn/03.png')
      ]);
      setImage(mainImg);
  ...
  const handleImageMouseMove = useMemo(() => (event) => {
    ...
    const inClickableArea = isPointInTvMove8Area(3, mouseX, mouseY, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove8ClickableAreas(3);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        ...
        >
          <img 
            src={image || "/tv/pictures/tv2/move-8/regular/03.png"}
          ...
          {getTvMove8ClickableAreas(3).map((area, index) => (
            <div
              key={`clickable-${index}`}
        ...
        {hoveredImage && !selectedImage && (() => {
          ...
          return (
            ...
            >
              <img
                src={hoverImage || "/tv/pictures/tv2/move-8/zoomBit/03.png"}
                alt="Hover Scene"
        ...
        {showZoomInModal && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center">
              {/* Main ZoomIn Image */}
              <img
                src={zoomInImage || "/tv/pictures/tv2/move-8/zoomIn/03.png"}
                alt="Zoomed In Scene"
                style={{ 
                  width: '1226px',
                  height: '664px',
              ...
              >
                ...
                <div style={{
                  ...
                  On the treasure chest, engravings of E.T. and Star Wars droids appear.
                </div>
              </div>
            </div>
          </div>
