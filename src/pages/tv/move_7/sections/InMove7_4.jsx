...
const InMove7_4 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv2/move-7/zoomBit/04.png'),
        getBase64('/tv/pictures/tv2/move-7/zoomIn/04.png')
      ]);
      setImage(mainImg);
  ...
  const imageZoomConfigs = useMemo(() => ({
    4: { zoomSize: 'w-[144px]', zoomHeight: 'h-[330px]', zoomOffset: { x: 835, y: 220 } }
  }), []);
  ...
  const handleImageMouseMove = useMemo(() => (event) => {
    ...
    const inClickableArea = isPointInTvMove7Area(4, mouseX, mouseY, rect.width, rect.height);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        ...
        >
          <img 
            src={image || "/tv/pictures/tv2/move-7/regular/04.png"}
        ...
        {((isAreaHovered || isHoveringZoomImage) && !selectedImage) && (() => {
          ...
          return (
            ...
            >
              <img
                src={hoverImage || "/tv/pictures/tv2/move-7/zoomBit/04.png"}
        ...
        {showZoomInModal && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center">
              {/* Main ZoomIn Image */}
              <img
                src={zoomInImage || "/tv/pictures/tv2/move-7/zoomIn/04.png"}
                alt="Zoomed In Scene"
                style={{ 
                  width: '907px',
                  height: '663px',
              ...
              >
                ...
                <div style={{
                  ...
                  In several scenes, a small headless statue can be seen in the background, hinting at the fate of Gwyneth Paltrow's character.
                </div>
              </div>
            </div>
          </div>
