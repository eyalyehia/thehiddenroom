...
const InMove7_3 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv2/move-7/zoomBit/03.png'),
        getBase64('/tv/pictures/tv2/move-7/zoomIn/03.png')
      ]);
      setImage(mainImg);
  ...
  const imageZoomConfigs = useMemo(() => ({
    3: { zoomSize: 'w-[259px]', zoomHeight: 'h-[215px]', zoomOffset: { x: 380, y: -200 } }
  }), []);
  ...
  const handleImageMouseMove = useMemo(() => (event) => {
    ...
    const inClickableArea = isPointInTvMove7Area(3, mouseX, mouseY, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove7ClickableAreas(3);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        ...
        >
          <img 
            src={image || "/tv/pictures/tv2/move-7/regular/03.png"}
          ...
          {getTvMove7ClickableAreas(3).map((area, index) => (
            <div
              key={`clickable-${index}`}
        ...
        {((isAreaHovered || isHoveringZoomImage) && !selectedImage) && (() => {
          ...
          return (
            ...
            >
              <img
                src={hoverImage || "/tv/pictures/tv2/move-7/zoomBit/03.png"}
        ...
        {showZoomInModal && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center">
              {/* Main ZoomIn Image */}
              <img
                src={zoomInImage || "/tv/pictures/tv2/move-7/zoomIn/03.png"}
                alt="Zoomed In Scene"
                style={{ 
                  width: '864px',
                  height: '663px',
              ...
              >
                ...
                <div style={{
                  ...
                  When Morgan Freeman's character arrives for dinner, the apartment number on the door is 5, a reference to the fifth sin, "Envy," which involves Gwyneth Paltrow's character.
                </div>
              </div>
            </div>
          </div>
