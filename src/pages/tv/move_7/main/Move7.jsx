        ...
        <div className="flex flex-wrap justify-center items-center gap-8 p-8 h-screen">
          ...
          <div className="flex gap-8">
            ...
            <div className="relative">
              ...
              >
                <img 
                  src="/tv/pictures/tv2/move-7/regular/01.png"
                  alt="Scene 1"
            ...
            <div className="relative">
              ...
              >
                <img 
                  src="/tv/pictures/tv2/move-7/regular/02.png"
                  alt="Scene 2"
                  className="w-full h-full object-cover"
                />
              </div>
          ...
          <div className="flex gap-8">
            ...
            <div className="relative">
              ...
              >
                <img 
                  src="/tv/pictures/tv2/move-7/regular/03.png"
                  alt="Scene 3"
                  className="w-full h-full object-cover"
                />
              </div>
            ...
            <div className="relative">
              ...
              >
                <img 
                  src="/tv/pictures/tv2/move-7/regular/04.png"
                  alt="Scene 4"
                  className="w-full h-full object-cover"
                />
              </div>
