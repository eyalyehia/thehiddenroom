...
const InMove4 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv1/move-1/zoonBit/04.png'),
        getBase64('/tv/pictures/tv1/move-1/zoomIn/04.png')
      ]);
      setImage(mainImg);
  ...
  const imageZoomConfigs = useMemo(() => ({
    4: { zoomSize: 'w-[126px]', zoomHeight: 'h-[212px]', zoomOffset: { x: -800, y: -150 } }
  }), []);
  ...
  const handleImageMouseMove = useMemo(() => (event) => {
    ...
    const inClickableArea = isPointInTvMove1Area(4, mouseX, mouseY, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove1ClickableAreas(4);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        ...
        >
          <img 
            src={image || "/tv/pictures/tv1/move-1/regular/04.png"}
          ...
          {getTvMove1ClickableAreas(4).map((area, index) => (
            <div
              key={`clickable-${index}`}
        ...
        {((isAreaHovered || isHoveringZoomImage) && !selectedImage) && (() => {
          ...
          return (
            ...
            >
              <img
                src={hoverImage || "/tv/pictures/tv1/move-1/zoonBit/04.png"}
        ...
        {showZoomInModal && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center">
              {/* Main ZoomIn Image */}
              <img
                src={zoomInImage || "/tv/pictures/tv1/move-1/zoomIn/04.png"}
                alt="Zoomed In Scene"
                style={{ 
                  width: '383px',
                  height: '663px',
              ...
              >
                ...
                <div style={{
                  ...
                  On the bedroom window, there's a faint bloodstain that's easy to miss because it passes by quickly.
                </div>
              </div>
            </div>
          </div>
