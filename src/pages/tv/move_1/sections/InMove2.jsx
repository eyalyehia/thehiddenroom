...
const InMove2 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv1/move-1/zoonBit/02.png'),
        getBase64('/tv/pictures/tv1/move-1/zoomIn/02.png')
      ]);
      setImage(mainImg);
  ...
  const handleImageMouseMove = useMemo(() => (event) => {
    ...
    const inClickableArea = isPointInTvMove1Area(2, mouseX, mouseY, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove1ClickableAreas(2);
    ...
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        ...
        >
          ...
          {getTvMove1ClickableAreas(2).map((area, index) => (
            <div
              key={`clickable-${index}`}
        ...
        {hoveredImage && !selectedImage && (() => {
          ...
          return (
            ...
            >
              <img
                src={hoverImage || "/tv/pictures/tv1/move-1/zoonBit/02.png"}
                alt="Hover Scene"
        ...
        {showZoomInModal && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center">
              {/* Main ZoomIn Image */}
              <img
                src={zoomInImage || "/tv/pictures/tv1/move-1/zoomIn/02.png"}
                alt="Zoomed In Scene"
                style={{ 
                  width: '776px',
                  height: '662px',
              ...
              >
                ...
                <div style={{
                  ...
                  In the boy's room, there's a drawing of red doors on the wall, <br />
                  a reference to the future sequel Insidious: The Red Door.
                </div>
              </div>
            </div>
          </div>
