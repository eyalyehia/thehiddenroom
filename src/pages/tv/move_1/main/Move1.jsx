      ...
      <div className="w-full h-full flex flex-wrap justify-center items-center gap-8 p-16">
        ...
        <div className="flex gap-8">
          ...
          >
            ...
            >
              <img 
                src="/tv/pictures/tv1/move-1/regular/01.png"
                alt="Scene 1"
          ...
          >
            ...
            >
              <img 
                src="/tv/pictures/tv1/move-1/regular/02.png"
                alt="Scene 2"
                className="w-full h-full object-cover"
              />
            </div>
        ...
        <div className="flex gap-8">
          ...
          >
            ...
            >
              <img 
                src="/tv/pictures/tv1/move-1/regular/03.png"
                alt="Scene 3"
                className="w-full h-full object-cover"
              />
            </div>
          ...
          >
            ...
            >
              <img 
                src="/tv/pictures/tv1/move-1/regular/04.png"
                alt="Scene 4"
                className="w-full h-full object-cover"
              />
            </div>
