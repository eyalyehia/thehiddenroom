...
const InMove2_4 = () => {
  ...
  const imageZoomConfigs = useMemo(() => ({
    4: { zoomSize: 'w-[353px]', zoomHeight: 'h-[206px]', zoomOffset: { x: -80, y: -225} }
  }), []);
  ...
  const handleImageMouseMove = (event) => {
    ...
    const inClickableArea = isPointInTvMove2Area(4, mouseX, mouseY, rect.width, rect.height);
    
    if (inClickableArea) {
      // setHoveredImage(4); // This line was removed as per the edit hint
    } else {
  ...
  return (
    <div className="relative w-full h-screen" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        <img 
          src={image || "/tv/pictures/tv1/move-2/regular/04.png"}
      ...
      {((isAreaHovered || isHoveringZoomImage)) && (() => {
        ...
        return (
          ...
          >
            <img
              src={hoverImage || "/tv/pictures/tv1/move-2/zoomBit/04.png"}
