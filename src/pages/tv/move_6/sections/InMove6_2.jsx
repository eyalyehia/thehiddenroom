...
const InMove6_2 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        getBase64('/tv/pictures/tv2/move-6/regular/02.png'),
        getBase64('/tv/pictures/tv2/move-6/zoomBit/02.png'),
        getBase64('/tv/pictures/tv2/move-6/zoomIn/02.png')
      ]);
      setImage(mainImg);
  ...
  const handleImageMouseMove = (event) => {
    ...
    const inClickableArea = isPointInTvMove6Area(2, mouseX, mouseY, rect.width, rect.height);
    
    if (inClickableArea) {
      // setHoveredImage(2); // This line is removed
    } else {
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove6ClickableAreas(2);
  ...
  return (
    <div className="relative w-full h-screen" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        <img 
          src={image || "/tv/pictures/tv2/move-6/regular/02.png"}
          alt="Full Screen Scene"
          className="w-full h-full object-cover"
        />
        {renderClickableAreasDebug()}
        {/* Add clickable area overlay */}
        {getTvMove6ClickableAreas(2).map((area, index) => (
          <div
            key={`clickable-${index}`}
      ...
      {((isAreaHovered || isHoveringZoomImage)) && (() => {
        ...
        return (
          ...
          >
            <img
              src={hoverImage || "/tv/pictures/tv2/move-6/zoomBit/02.png"}
        ...
        >
          <div className="relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col items-center">
              {/* Image */}
              <img
                src={zoomImage || "/tv/pictures/tv2/move-6/zoomIn/02.png"}
                alt="Zoomed Scene"
                style={{
                  width: '1038px',
                  height: '663px',
