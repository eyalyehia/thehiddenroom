...
const InMove4_1 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv1/move-4/zoomIn/01.jpg')
      ]);
      setImage(mainImg);
  ...
  const imageZoomConfigs = useMemo(() => ({
    1: { zoomSize: 'w-[155px]', zoomHeight: 'h-[89px]', zoomOffset: { x: 790, y: 265 } }
  }), []);
        ...
        >
          <div className="relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col items-center">
              {/* Image */}
              <img
                src={zoomImage || "/tv/pictures/tv1/move-4/zoomIn/01.jpg"}
                alt="Zoomed Scene"
                style={{
                  width: '994px',
                  height: '663px',
