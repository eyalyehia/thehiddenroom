...
const InMove4_4 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [mainImg, hoverImg, zoomImg] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv1/move-4/zoomBit/04.png'),
        getBase64('/tv/pictures/tv1/move-4/zoomIn/04.png')
      ]);
      setImage(mainImg);
  ...
  const handleImageMouseMove = (event) => {
    ...
    const inClickableArea = isPointInTvMove4Area(4, mouseX, mouseY, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getTvMove4ClickableAreas(4);
  ...
  return (
    <div className="relative w-full h-screen" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      >
        <img 
          src={image || "/tv/pictures/tv1/move-4/regular/04.png"}
          alt="Full Screen Scene"
          className="w-full h-full object-cover"
        />
        {renderClickableAreasDebug()}
        {/* Add clickable area overlay */}
        {getTvMove4ClickableAreas(4).map((area, index) => (
          <div
            key={`clickable-${index}`}
      ...
      {hoveredImage && (() => {
        ...
        return (
          ...
          >
            <img
              src={hoverImage || "/tv/pictures/tv1/move-4/zoomBit/04.png"}
              alt="Hover Scene"
        ...
        >
          <div className="relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col items-center">
              {/* Image */}
              <img
                src={zoomImage || "/tv/pictures/tv1/move-4/zoomIn/04.png"}
                alt="Zoomed Scene"
                style={{
                  width: '475px',
                  height: '663px',
