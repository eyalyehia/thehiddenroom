...
const InsideGame7 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page2/game3/regular/01.png'),
          getBase64('/computer/pictures/page2/game3/zoomBitIn/01.png'),
          getBase64('/computer/pictures/page2/game3/zoomIn/01.png')
        ]);
      } catch (error) {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game7', 1, x, y, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game7', 1);
    ...
    <div style={{ 
      ...
      {showModal && (
        ...
        >
          ...
          >
            <img
              src="/computer/pictures/page2/game3/zoomIn/01.png"
            ...
            >
              ...
              <div style={{ 
                ...
                lineHeight: '128.04%',
                  marginBottom: '0'
                }}>APPROXIMATELY 15–30 MINUTES INTO THE GAME</div>
              <div style={{
                  width: '907px',
                  height: '40px',
                  display: 'flex',
                  ...
                  <div style={{
                    ...
                    whiteSpace: 'nowrap'
                  }}>Early in the game, a frozen alien body can be</div>
                  <div style={{
                    fontWeight: 400,
                    fontSize: '20px',
                  lineHeight: '20px',
                  ...
                  // overflow: 'hidden',
                    textOverflow: 'ellipsis',
                    whiteSpace: 'nowrap'
                  }}> seen trapped under the ice beneath a bridge.</div>
                </div>
              </div>
            </div>
          </div>
