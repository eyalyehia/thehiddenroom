...
const InsideGame8_3 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page2/game4/regular/04.png'),
          getBase64('/computer/pictures/page2/game4/zoomBitIn/04.png'),
          getBase64('/computer/pictures/page2/game4/zoomIn/04.png')
        ]);
      } catch (error) {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game8', 4, x, y, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game8', 4);
  ...
  return (
    <div style={{ 
      ...
      {isHovering && (
        ...
        >
          <img
            src="/computer/pictures/page2/game4/zoomBitIn/04.png"
            alt="Zoomed Game 8"
            style={{
              width: '100%',
              height: '100%',
      ...
      {showModal && (
        ...
        >
          ...
          >
            <img
              src="/computer/pictures/page2/game4/zoomIn/04.png"
            ...
            >
              ...
              <div style={{
                ...
                Deep underwater, you can find a sunken ship containing a skeleton with a Clicker-style fungal head, a reference to The Last of Us.
              </div>
            </div>
          </div>
        </div>
