...
const InsideGame8_2 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page2/game4/regular/03.png'),
          getBase64('/computer/pictures/page2/game4/zoomBitIn/03.png'),
          getBase64('/computer/pictures/page2/game4/zoomIn/03.webp')
        ]);
      } catch (error) {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game8', 3, x, y, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game8', 3);
    ...
    <div style={{ 
      ...
      {isHovering && (
        ...
        >
          <div style={{
            ...
            <img
              src="/computer/pictures/page2/game4/zoomBitIn/03.png"
              alt="Zoomed Game 8"
      ...
      {showModal && (
        ...
        >
          ...
          >
            <img
              src="/computer/pictures/page2/game4/zoomIn/03.webp"
