...
const InsideGame6 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page2/game2/regular/01.png'),
          getBase64('/computer/pictures/page2/game2/zoomBitIn/01.png'),
          getBase64('/computer/pictures/page2/game2/zoomIn/01.png')
        ]);
      } catch (error) {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game6', 1, x, y, rect.width, rect.height);
  ...
  return (
    <div style={{ 
      ...
      >
        <img
          src="/computer/pictures/page2/game2/regular/01.png"
          alt="Game 6 Scene 1"
          style={{
            width: '100%',
            height: '100%',
      ...
      {showModal && (
        ...
        >
          ...
          >
            <img
              src="/computer/pictures/page2/game2/zoomIn/01.png"
            ...
            >
              ...
              <div style={{
                  ...
                  <div style={{
                    ...
                    whiteSpace: 'nowrap'
                  }}>You can find a carved wooden statue of Brok</div>
                  <div style={{
                    fontWeight: 400,
                    fontSize: '20px',
                  lineHeight: '20px',
                  ...
                  // overflow: 'hidden',
                    textOverflow: 'ellipsis',
                    whiteSpace: 'nowrap'
                  }}> and Sindri, the dwarf brothers from God of War.</div>
                </div>
              </div>
            </div>
          </div>
