...
const InsideGame61 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page2/game2/regular/02.png'),
          getBase64('/computer/pictures/page2/game2/zoomBitIn/02.png'),
          getBase64('/computer/pictures/page2/game2/zoomIn/02.png')
        ]);
      } catch (error) {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game6', 2, x, y, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game6', 2);
  ...
  return (
    <div style={{ 
      ...
      >
        <img
          src="/computer/pictures/page2/game2/regular/02.png"
          alt="Game 6 Scene 2"
          style={{
            width: '100%',
            height: '100%',
      ...
      {isHovering && (
        ...
        >
          ...
          <img
            src="/computer/pictures/page2/game2/zoomBitIn/02.png"
            alt="Zoomed Game 6"
      ...
      {showModal && (
        ...
        >
          ...
          >
            <img
              src="/computer/pictures/page2/game2/zoomIn/02.png"
            ...
            >
              ...
              <div style={{ 
                ...
                lineHeight: '128.04%',
                  marginBottom: '0'
                }}>APPROXIMATELY 2-4 HOURS INTO THE GAME</div>
              <div style={{
                  width: '907px',
                  height: '40px',
                  display: 'flex',
                  ...
                  <div style={{
                    ...
                    whiteSpace: 'nowrap'
                  }}>You can find a small snowy cabin that mirrors Kratos's home from God </div>
                  <div style={{
                    fontWeight: 400,
                    fontSize: '20px',
                  lineHeight: '20px',
                  ...
                  overflow: 'hidden',
                    textOverflow: 'ellipsis',
                    whiteSpace: 'nowrap'
                  }}>of War. Inside, there are subtle props that reference his story and past.</div>
                </div>
              </div>
            </div>
          </div>
