...
const Logo2 = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      {/* כפתור חזור */}
      <button
        className="fixed left-6 top-1/2 transform -translate-y-1/2 transition-all duration-200 ease-in-out z-50 cursor-pointer border-0 outline-none focus:outline-none"
        style={{ 
          width: '29px', 
          height: '45px',
