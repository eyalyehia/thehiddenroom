...
const InsideGame2_1 = () => {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game2', 2, x, y, rect.width, rect.height);
  ...
  return (
    <div className="relative w-full h-screen bg-white overflow-hidden">
      ...
      >
        <MemoizedImage
          src="/computer/pictures/page1/game2/regular/02.png"
      ...
      {isHovering && !selectedImage && (
        ...
        >
          <MemoizedImage
            src="/computer/pictures/page1/game2/zoomBitIn/02.png"
            alt="Zoomed Game 2"
      ...
      {selectedImage && (
        ...
        >
          <div className="relative" style={{ width: modalConfig.width, height: modalConfig.height }}>
            <MemoizedImage
              src="/computer/pictures/page1/game2/zoomIn/02.png"
            ...
            >
              ...
              >
                An abandoned cabin hides a mysterious note about sky beings. Return at 2 AM to see a UFO hovering above.
              </div>
            </div>
          </div>
        </div>
