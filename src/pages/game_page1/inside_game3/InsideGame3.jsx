...
const InsideGame3 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page1/game3/regular/01.png'),
          getBase64('/computer/pictures/page1/game3/zoomBitIn/01.png')
        ]);
      } catch (error) {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game3', 1, x, y, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game3', 1);
