...
const InsideGame3_1 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page1/game3/regular/02.png'),
          getBase64('/computer/pictures/page1/game3/zoomBitIn/02.png')
        ]);
      } catch (error) {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game3', 2, x, y, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game3', 2);
  ...
  return (
    <div style={{
      ...
      >
        <img
          src="/computer/pictures/page1/game3/regular/02.png"
          alt="Game 3 Detail 2"
          style={{
            width: '100%',
            height: '100%',
      ...
      {isHovering && (
        ...
        >
          <img
            src="/computer/pictures/page1/game3/zoomBitIn/02.png"
            alt="Zoomed Game 3"
            style={{
              width: '100%',
              height: '100%',
