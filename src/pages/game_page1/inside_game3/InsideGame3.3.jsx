...
const InsideGame3_3 = () => {
  ...
  const handleMouseMove = (event) => {
    ...
    const isInArea = isPointInComputerGameArea('game3', 4, x, y, rect.width, rect.height);
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game3', 4);
  ...
  return (
    <div className="relative w-full h-screen bg-white overflow-hidden">
      ...
      >
        <MemoizedImage
          src="/computer/pictures/page1/game3/regular/04.png"
          alt="Game 3 Detail 4"
      ...
      {isHovering && !selectedImage && (
        ...
        >
          <div style={{
            ...
            <MemoizedImage
              src="/computer/pictures/page1/game3/zoomBitIn/04.png"
              alt="Zoomed Game 3"
      ...
      {selectedImage && (
        ...
        >
          <div className="relative" style={{ width: modalConfig.width, height: modalConfig.height }}>
            <MemoizedImage
              src="/computer/pictures/page1/game3/zoomIn/04.png"
            ...
            >
              <div className="text-left">
                <div style={{
                  ...
                  lineHeight: '128.04%',
                  marginBottom: '0'
                }}>APPROXIMATELY 15–20 MINUTES INTO THE GAME</div>
                <div style={{
                  width: '645px',
                  height: '40px',
                  display: 'flex',
                  ...
                  <div style={{
                    ...
                    whiteSpace: 'nowrap'
                  }}>“Hotel Corleone” is a reference to The movie "Godfather", named after the iconic Corleone family.</div>
                  {/* <div style={{
                    fontWeight: 400,
                    fontSize: '20px',
                    lineHeight: '20px',
                    ...
                    textOverflow: 'ellipsis',
                    whiteSpace: 'nowrap'
                  }}>several famous country artists he mentioned in the first game.</div> */}
                </div>
              </div>
            </div>
          </div>
