...
const InsideGame1_3 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page1/game1/regular/03.png'),
          getBase64('/computer/pictures/page1/game1/zoonBitIn/03.png')
        ]);
      } catch (error) {
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game1', 3);
