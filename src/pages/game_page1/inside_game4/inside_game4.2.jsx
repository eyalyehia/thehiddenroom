...
const InsideGame4_2 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page1/game4/regular/03.png'),
          getBase64('/computer/pictures/page1/game4/zoomBitIn/03.png')
        ]);
      } catch (error) {
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game4', 3);
