...
const InsideGame4_3 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all([
          getBase64('/computer/pictures/page1/game4/regular/04.png'),
          getBase64('/computer/pictures/page1/game4/zoomBitIn/04.png')
        ]);
      } catch (error) {
  ...
  const renderClickableAreasDebug = () => {
    ...
    const areas = getComputerGameClickableAreas('game4', 4);
